...
def on_message(mqttc, obj, msg):
    ...
    rgb_values_list = tuple(*ast.literal_eval(rgb_values_list))

    print(rgb_values_list[0])


    time.sleep(1)

    # print(list(*rgb_values_list[0]))
    # for pixel in range(LEDS_PER_PIXEL):
    #     update_led_strip(tuple(*rgb_values_list[0]), pixel, strip)

    # for pixel in range(LEDS_PER_PIXEL, LEDS_PER_PIXEL*2):
    #     update_led_strip(tuple(*rgb_values_list[1]), pixel, strip)

    # for pixel in range(LEDS_PER_PIXEL*2, LEDS_PER_PIXEL*3):
    #     update_led_strip(tuple(*rgb_values_list[2]), pixel, strip)

    # for pixel in range(LEDS_PER_PIXEL*3, LEDS_PER_PIXEL*4):
    #     update_led_strip(tuple(*rgb_values_list[3]), pixel, strip)

    # for pixel in range(LEDS_PER_PIXEL*4, LEDS_PER_PIXEL*5):
    #     update_led_strip(tuple(*rgb_values_list[4]), pixel, strip)

    # for pixel in range(LEDS_PER_PIXEL*5, LEDS_PER_PIXEL*6):
    #     update_led_strip(tuple(*rgb_values_list[5]), pixel, strip)
